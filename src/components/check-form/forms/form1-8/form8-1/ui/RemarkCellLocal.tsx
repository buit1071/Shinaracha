...
import NoteModalLocal from "./NoteModalLocal";
...
// ช่องหมายเหตุ (truncate + ปุ่มดินสอ + Modal) — Local สำหรับ Form8_1
export default function RemarkCellLocal({ note, placeholder = "หมายเหตุ (ถ้ามี)", onSave }: Props) {
