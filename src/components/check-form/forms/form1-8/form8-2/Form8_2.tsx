...
// Main 1.x sections
import Form8_2_Report_1_0 from "./Form8_2_Report_1_0";
import Form8_2_Report_1_1 from "./Form8_2_Report_1_1";
import Form8_2_Report_1_2 from "./Form8_2_Report_1_2";
import Form8_2_Report_1_3 from "./Form8_2_Report_1_3";
import Main1_Inspect from "./Main1_Inspect";
import Form8_2_Report_1_4 from "./Form8_2_Report_1_4";

// Plan 2.x sections
import Form8_2_Plan_2_1 from "./Form8_2_Plan_2_1";
import Form8_2_Plan_2_2 from "./Form8_2_Plan_2_2";
import Form8_2_Plan_2_3 from "./Form8_2_Plan_2_3";
import Form8_2_Plan_2_4 from "./Form8_2_Plan_2_4";
import Form8_2_Plan_2_5 from "./Form8_2_Plan_2_5";
import Form8_2_Plan_2_6 from "./Form8_2_Plan_2_6";
import Form8_2_Plan_2_7 from "./Form8_2_Plan_2_7";
...
export default function Form8_2({ jobId, equipment_id, name, onBack }: Props) {
          ...
          <div className={`grid transition-[grid-template-rows,opacity] duration-300 ease-out ${openMain.includes("main-1") ? "grid-rows-[1fr] opacity-100" : "grid-rows-[0fr] opacity-0"}`}>
            <div className="overflow-hidden"><div className="p-2">
              <Section id="report" title={`รายงานผลการตรวจสอบป้าย ปี ${formData.report?.year ?? ""}`}>
                <Form8_2_Report_1_0 value={formData.report} onChange={setReport} jobId={jobId} name={name} inspectorName={username} />
              </Section>
              <Section id="general" title="ส่วนที่ 1 ขอบเขตของการตรวจสอบป้าย">
                <Form8_2_Report_1_1 value={formData.report} onChange={setReport} />
              </Section>
              ...
              <Section id="inspect" title="ส่วนที่ 3 ผลการตรวจสอบสภาพป้ายและอุปกรณ์ประกอบของป้าย">
                <Form8_2_Report_1_3 installType={formData.report?.installType} value={formData.inspect} onChange={setInspect} />
                <div className="mt-4" />
              ...
              <Section id="summary" title="ส่วนที่ 4 สรุปผลการตรวจสอบป้าย">
                <Form8_2_Report_1_4 general={formData.general} summary={formData.summary} signoff={formData.signoff} onChangeSummary={setSummary} onChangeSignoff={setSignoff} />
              </Section>
            </div></div>
          </div>
        </section>
