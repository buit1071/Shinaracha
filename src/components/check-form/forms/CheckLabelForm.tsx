...
import CompanyHeader from "@/components/check-form/forms/CompanyHeader";
import SectionOneDetails from "@/components/check-form/forms/SectionOneDetails";
import SectionTwoDetails from "@/components/check-form/forms/SectionTwoDetails";
import SectionThreeDetails from "@/components/check-form/forms/SectionThreeDetails";
import SectionFourDetails from "@/components/check-form/forms/SectionFourDetails";
import SectionFiveDetails from "@/components/check-form/forms/SectionFiveDetails";

export default function CheckLabelForm() {
